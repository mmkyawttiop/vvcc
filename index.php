...
<body onload="ccgen();"style="background: #191C25;">
...
<center>
						<img class="rounded-circle" src="assets/img/hschecker.png" width="100" height="100" style="margin-top: 30px;">
</center>
...
<button style="margin-top: 20px" type="button" class="btn btn-outline-danger btn-block" onclick="modalCCGEN();">Random Test Credit Card Numbers Generator</button>
					...
					<div class="form-group">
						...
						<select class="form-control" id="api" style="background: transparent;color: #FFFFFF;">
							<?php for ($i=0; $i < count($api_file); $i++) {
								echo '<option style="background: #191C25" value="'.$api_file[$i].'">'.$api_name[$i].'</option>';
							}?>	
					    </select>
					</div>
					<div class="form-group">
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p style="color: #FFFFFF">MYANMAR CHECKER EDITED BY @HS</p></center></div>
	</div>
	...
	<div class="modal fade" id="ccGEN" role="dialog" aria-hidden="true" >
		<div class="modal-dialog modal-dialog-centered"  style="background: transparent;">
			<div class="modal-content" style="background: transparent;">
				<div class="modal-body" style="background: #191C25">
					<center style="margin-bottom: 20px">
						<img class="rounded-circle" src="<?php echo $site_icon; ?>" width="150" height="150" style="margin-top: 10px;margin-bottom: 20px;" >
								...
								<div class="col-4 col-lg-4">
									<div class="form-group">
										...
										<select class="form-control text-white" style="background: transparent;" name="emeses">
											<option style="background: #191C25" value="rnd">RANDOM  </option>
											<option style="background: #191C25" value="01">01 - JAN</option>
											<option style="background: #191C25" value="02">02 - FEB</option>
											<option style="background: #191C25" value="03">03 - MAR</option>
											<option style="background: #191C25" value="04">04 - APR</option>
											<option style="background: #191C25" value="05">05 - MAY</option>
											<option style="background: #191C25" value="06">06 - JUN</option>
											<option style="background: #191C25" value="07">07 - JUL</option>
											<option style="background: #191C25" value="08">08 - AUG</option>
											<option style="background: #191C25" value="09">09 - SEP</option>
											<option style="background: #191C25" value="10">10 - OCT</option>
											<option style="background: #191C25" value="11">11 - NOV</option>
											<option style="background: #191C25" value="12">12 - DEC</option>
										</select>
									</div>
								</div>
								<div class="col-4 col-lg-4">
									<div class="form-group">
										...
										<select class="form-control text-white" style="background: transparent;" name="eyear">
											<option style="background: #191C25" value="rnd">RANDOM</option>
											<option style="background: #191C25" value="2020">2020</option>
											<option style="background: #191C25" value="2021">2021</option>
											<option style="background: #191C25" value="2022">2022</option>
											<option style="background: #191C25" value="2023">2023</option>
											<option style="background: #191C25" value="2024">2024</option>
											<option style="background: #191C25" value="2025">2025</option>
											<option style="background: #191C25" value="2026">2026</option>
											<option style="background: #191C25" value="2027">2027</option>
											<option style="background: #191C25" value="2028">2028</option>
											<option style="background: #191C25" value="2029">2029</option>
											<option style="background: #191C25" value="2030">2030</option>
										</select>
									</div>
								</div>
								<div class="col-4  col-lg-4">
	...
	<div class="modal fade" id="Modal" data-keyboard="false" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog  modal-dialog-centered">
			<div class="modal-content" style="background: #191C25">
				<div class="modal-body" style="background: #191C25">
					<center style="margin-bottom: 20px">
